...
public class DataHolder {
    ...
    public void init() {
        ...
        List<Song> pesni = new ArrayList<>();

        pesni.add(songList.get(0));
        pesni.add(songList.get(1));
        albumList.add(new Album("Album1", "Rock", "2020", pesni));
        pesni.clear();

        pesni.add(songList.get(2));
        pesni.add(songList.get(3));
        albumList.add(new Album("Album2", "Turbofolk", "2000", pesni));
        pesni.clear();

        pesni.add(songList.get(3));
        pesni.add(songList.get(4));
        albumList.add(new Album("Album3", "Rock", "2020", pesni));
        pesni.clear();

        pesni.add(songList.get(5));
        pesni.add(songList.get(1));
        albumList.add(new Album("Album4", "Rock", "2020", pesni));
        pesni.clear();

        pesni.add(songList.get(2));
        pesni.add(songList.get(4));
        albumList.add(new Album("Album5", "Rock", "2020", pesni));
        pesni.clear();
